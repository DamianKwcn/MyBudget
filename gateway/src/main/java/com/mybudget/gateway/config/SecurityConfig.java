    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        http
                ...
                .authorizeExchange(exchange -> exchange
                        .pathMatchers("/mybudget/accounts/version").permitAll()
                        .pathMatchers("/actuator/**").permitAll()
                        .pathMatchers("/mybudget/orchestrator/**").permitAll()
                        .pathMatchers("/mybudget/accounts/user/initialize").permitAll()
                        .pathMatchers("/mybudget/accounts/user/delete").permitAll()
